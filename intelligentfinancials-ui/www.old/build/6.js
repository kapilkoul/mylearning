...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__signup__ = __webpack_require__(372);
...
var SignupPage = (function () {
    function SignupPage(navCtrl, user, toastCtrl, translateService, events) {
        var _this = this;
    ...
    SignupPage.prototype.doSignup = function () {
        ...
        this.user.signup(this.account)
            ...
            _this.events.publish("loading:show", 'Signup done. Logging in...');
            return _this.user.login(_this.account);
        })
            .then(function (resp) {
            _this.events.publish("loading:hide");
            ...
            var toast = _this.toastCtrl.create({
                message: _this.signupErrorString + " | " + err.message,
                duration: 3000,
                position: 'top'
            });
            toast.present();
